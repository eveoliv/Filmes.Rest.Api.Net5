...
namespace Filmes.Rest.Api.Net5.Migrations
{
    ...
    [Migration("20211116235759_CinemaFilmeBuilder")]
    partial class CinemaFilmeBuilder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Filmes.Rest.Api.Net5.Models.Sessao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Filmes.Rest.Api.Net5.Models.Sessao", b =>
                {
                    b.HasOne("Filmes.Rest.Api.Net5.Models.Cinema", "Cinema")
                        .WithMany("Sessoes")
                        .HasForeignKey("CinemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Filmes.Rest.Api.Net5.Models.Filme", "Filme")
                        .WithMany("Sessoes")
